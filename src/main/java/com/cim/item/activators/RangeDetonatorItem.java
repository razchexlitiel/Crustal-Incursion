...
public class RangeDetonatorItem extends Item {
            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                ...
                if (!level.isLoaded(targetPos)) {
                    player.displayClientMessage(
                            Component.translatable("message.cim.range_detonator.pos_not_loaded")
                ...
                if (block instanceof IDetonatable detonatable) {
                    ...
                    if (success) {
                        player.displayClientMessage(
                                Component.translatable("message.cim.range_detonator.activated")
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level,
        ...
        tooltip.add(Component.translatable("tooltip.cim.range_detonator.desc")
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("tooltip.cim.range_detonator.hint")
                .withStyle(ChatFormatting.GRAY));
    }
}
